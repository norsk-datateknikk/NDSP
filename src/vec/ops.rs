...
impl <T1: MixedNum + MixedNumConversion<T2>, T2: MixedNum + MixedOps> ops::Mul<Vec<T1>> for Vec<T2> {
    type Output = Vec<T2>;
...
impl <T1: MixedNum + MixedNumConversion<T2>, T2: MixedNum + MixedOps> ops::Mul<T1> for Vec<T2> {
    type Output = Vec<T2>;
    /// ## Example
    /// 
    /// ```
